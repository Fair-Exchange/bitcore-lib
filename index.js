...
bitcore.versionGuard = function(version) {
  if (version !== undefined) {
    var message = 'More than one instance of bitcore-lib-safe-mini found. ' +
      'Please make sure to require bitcore-lib-safe-mini and check that submodules do' +
      ' not also include their own bitcore-lib-safe-mini dependency.';
